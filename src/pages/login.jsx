      ...
      <main className="relative w-full max-w-5xl">
        <div className="grid lg:grid-cols-2 bg-white rounded-3xl shadow-2xl shadow-teal-900/10 overflow-hidden border border-teal-100">
          {/* =====================================================
              LEFT PANEL
          ===================================================== */}
          <section className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-teal-800 via-teal-600 to-cyan-500 text-white p-12 flex-col justify-between min-h-[650px]">
            {/* Decorative circles */}
            <div
            ...
            <div className="relative z-10">
              ...
              <div>
                ...
                <p className="text-teal-50/90 leading-relaxed max-w-md">
                  Monitor disease cases, analyze epidemiological
                  information, track laboratory results and support
